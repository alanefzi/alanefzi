...
<h1>Hi, I'm Alaa Nefzi 👋</h1>
<h3>Flutter Developer | Laravel Developer | Full Stack Developer</h3>
...
![Hits](https://hits.seeyoufarm.com/api/count/incr/badge.svg?url=https%3A%2F%2Fgithub.com%2FALA-NEFZI&count_bg=%2379C83D&title_bg=%23555555&icon=mediafire.svg&icon_color=%23E7E7E7&title=HITS&edge_flat=false)
...
class About extends Me { 
  const myTools = {  
    "MobileDevelopment" : { "Flutter", "Dart", "Firebase", "Google Maps API" },
    "BackendDevelopment" : { "Laravel", "PHP", "MySQL", "RESTful APIs" },
    "FrontendDevelopment" : { "React.js", "Next.js", "JavaScript", "HTML5", "CSS3" },
    "DevOpsDeployment" : { "Ubuntu VPS", "Nginx", "Git & GitHub", "Docker" }
  };
}
